...
?>Скачать файл <a href="/examples/download/manual.zip">manual.zip</a>
    ...
    <br/><br/>
    В каталоге
    <b>/examples/download/</b> находится пример скачивания общедоступных файлов с сайта с фиксацией событий в модуле статистики. Все файлы для скачивания лежат в каталоге
    <i>/examples/download/files/</i>.
    ...
    <i>.htaccess</i> в текущем каталоге. В нашем примере это файл <i>download.php</i>.
    <br/><br/>
    ...
    <ol>
        ...
        <li>В скрипте <i>download_balance.php</i> раскомментировать массив <i>$arrHOSTS</i> и задать в нем адреса
            серверов для скачиваний и вероятности выбора того или иного сервера.
        </li>
    </ol>
    ...
    <br/><br/>
    В каталоге
    <b>/examples/download/download_private/</b> приведен пример реализации скачивания файлов с ограниченным доступом с фиксацией события в модуле статистики.
    <br/><br/>
    Все файлы лежат в каталоге
    <i>/examples/download/download_private/files/</i>, а ссылка на файл для скачивания имеет вид:
    ...
    <i>/files</i> имеют только зарегистрированные пользователи.
    <br/>
